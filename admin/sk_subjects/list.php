...
switch($_REQUEST['order']) {
	...
	case 'colors':
	case 'colors_asc':
		$order_clause = " ORDER BY colors ASC";
		$order_link_arg_head = "colors_dsc";
		$order_link_arg = "colors_asc";
		break;
	case 'colors_dsc':
		$order_clause = " ORDER BY colors DESC";
		$order_link_arg_head = "colors_asc";
		$order_link_arg = "colors_dsc";
		break;
	default:
...
$query = "SELECT * FROM sk_subjects".$order_clause." LIMIT ".$offset.",".$list_limit;
$query_c = "SELECT count(*) FROM sk_subjects";
